...
import io.zentechgh.dms.mobile.app.adapter.RecyclerViewAdapterReceived;
...
public class ReceivedDocumentActivity extends AppCompatActivity{
    ...
    List<Received_Documents> documentsList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dBRef = FirebaseDatabase.getInstance().getReference("Received_Documents")
        ...
        dBRef.child("Documents").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    Received_Documents received_documents = snapshot.getValue(Received_Documents.class);
