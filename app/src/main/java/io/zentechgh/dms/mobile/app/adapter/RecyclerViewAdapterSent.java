...
public class RecyclerViewAdapterSent extends RecyclerView.Adapter<RecyclerViewAdapterSent.ViewHolder> {
    ...
    private List<Sent_Documents> documentsList;

    // default constructor
    public RecyclerViewAdapterSent(){}

    // defaultless constructor
    public RecyclerViewAdapterSent(Context mCtx, List<Sent_Documents> documentsList){
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        final Sent_Documents documents = documentsList.get(position);
